...
Originally forked from [sameersbn/docker-squid](https://github.com/sameersbn/docker-squid).
...
```bash
docker build -t ekultails/squid .
```
...
To upgrade to newer releases:
  ...
  ```bash
  docker pull ekultails/squid:latest
  ```
